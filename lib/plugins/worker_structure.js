...
{
	return _preProcess(parsedFiles, filenames, "structure", "defineStructure");
} // preProcess
...
{
	_postProcess(parsedFiles, filenames, preProcessResults, "structure", "defineStructure");
} // postProcess
 ...
 * @param {String} defineStructureName
 */
function _postProcess(parsedFiles, filenames, preProcessResults, structureName, defineStructureName)
{
	for(var fileIndex = 0; fileIndex < parsedFiles.length; fileIndex += 1)
	{
		var parsedFile = parsedFiles[fileIndex];
