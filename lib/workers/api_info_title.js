...
{
	return apiWorker.preProcess(parsedFiles, filenames, packageInfos, "infoTitle");
} // preProcess
...
{
	apiWorker.postProcess(parsedFiles, filenames, preProcessResults, packageInfos, "info", "infoTitle");
} // postProcess
