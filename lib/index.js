...
function createOutputFiles (api) {
  ...
  app.log.verbose('copy require library to: ' + app.options.dest);
  if (!app.options.simulate) { fs.copySync('./node_modules/requirejs/require.js', app.options.dest + '/vendor/require.js'); }
