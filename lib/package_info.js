...
PackageInfo.prototype._readPackageData = function(filename) {
    ...
    if ( ! fs.existsSync(jsonFilename)) {
        ...
        try {
            ...
            packageInfo.name        = packageInfo.name || json.name;
            packageInfo.version     = packageInfo.version || json.version;
            packageInfo.description = packageInfo.description || json.description;
        } catch (e) {
