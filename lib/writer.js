...
class Writer {
  ...
  createOutputFiles () {
    ...
    // save the api data file
    if (this.opt.datafile) {
      this.log.verbose('Saving api-data to: ' + assetsPath);
      this.fs.writeFileSync(this.path.join(assetsPath, 'api-data.json'), this.api.data);
    }
