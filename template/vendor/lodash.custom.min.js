 ...
 * Build: `lodash -p -o template/vendor/lodash.custom.min.js include="get,set,groupBy,each,extend,some" exports="amd"`
 */
...
c):Mt;for(u&&ct(r[0],r[1],u)&&(c=3>o?Mt:c,o=1),e=Object(e);++n<o;)(u=r[n])&&t(e,u,n,c);return e})}(function(t,e){G(e,St(e),t)});l.assignIn=Ze,l.constant=zt,l.groupBy=qe,l.iteratee=xt,l.keys=Ot,l.keysIn=St,l.memoize=ht,l.property=Et,l.set=function(t,e,r){if(null!=t&&vt(t)){e=R(e,t);for(var n=-1,o=e.length,c=o-1,u=t;null!=u&&++n<o;){var i=st(e[n]),a=r;if(n!=c){var f=u[i],a=Mt;a===Mt&&(a=vt(f)?f:ot(e[n+1])?[]:{})}v(u,i,a),u=u[i]}}return t},l.extend=Ze,l.eq=pt,l.forEach=bt,l.get=wt,l.hasIn=mt,l.identity=kt,
l.isArguments=He,l.isArray=Je,l.isArrayLike=yt,l.isBuffer=Ke,l.isFunction=jt,l.isLength=_t,l.isMap=Qe,l.isObject=vt,l.isObjectLike=gt,l.isSet=Xe,l.isSymbol=dt,l.isTypedArray=Ye,l.stubArray=Ft,l.stubFalse=It,l.some=function(t,e,r){var n=Je(t)?c:V;return r&&ct(t,e,r)&&(e=Mt),n(t,Y(e,3))},l.toString=At,l.each=bt,l.VERSION="4.17.5",typeof define=="function"&&typeof define.amd=="object"&&define.amd&& define(function(){return l})}).call(this);